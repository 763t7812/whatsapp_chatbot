...
prompt_template = PromptTemplate(
    ...
    additionally always reply in the same language as the user is speaking. also Always respond with the above defined responses if the user messages one of the options 1, 2, or 3.
    {history}
    User: {message}
    """
)
