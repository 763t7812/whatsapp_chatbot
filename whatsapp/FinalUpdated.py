...
async def whatsapp_webhook(request: Request, background_tasks: BackgroundTasks):
    ...
    try:
        ...
        if message_info.get('purpose') == 'incorrecttask':
            response_message = message_info.get('response', "Para agendar uma reunião a sua mensagem deve conter a 'data' e a 'hora' da reunião Pode também adicionar o seu nome e a duração da reunião.")
