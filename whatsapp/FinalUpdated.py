...
prompt_template = PromptTemplate(
    ...
    always respond with this on the initial interaction with the user (always respond with this on the first interaction):
    ...
    If the user chooses option 2 (Technical support) then say:
    I will send you a link with our Support WhatsApp – WhatsApp link +351 934 750 410.

    If the user chooses option 3 (Other matters) then say:
